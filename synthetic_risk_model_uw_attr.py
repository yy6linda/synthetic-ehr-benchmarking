...
def cal_score(n, k):
    ...
    attr_idx = np.concatenate([np.array([0, 1, 2]), disease_attr_idx + 3])
...
if __name__ == '__main__':
    ...
    input_format = 'npy'
    SENSE_BEGIN = 3  # first 3 attributes are not sensitive
    N_attr = 2665  # number of total attributes
    exp_name = "Attr_Risk_"
    ...
    # load datasets
    if input_format == 'npy':
        real = prepare_data('data/' + original_patient_filename + '.npy')
    else:
